...
export default function App() {
  return (
    <>
      <Toaster position="top-center" toastOptions={{ style: { background:'#0d1018', color:'#e2e8f0', border:'1px solid rgba(148,175,230,0.14)', fontFamily:'Poppins,Inter,sans-serif', borderRadius:12 } }} />
      <Routes>
